...
namespace _15904_KleynaPHOTO.Controllers
{
    public class ZamowienieKlientController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            using (SqlConnection sqlCon = new SqlConnection(connectionString))
            {
                ...
                SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("select zamowienie.id, pracownik.imie, pracownik.nazwisko, " +
                    ...
                    "INNER JOIN koszyk on zamowienie.id = koszyk.zamowienie_id INNER JOIN produkt ON koszyk.produkt_id = produkt.id " +
                    "where klient.id=@ID;", sqlCon);
                sqlDataAdapter.SelectCommand.Parameters.AddWithValue("@ID", @User.FindFirst("id").Value);
        ...
        // GET: ZamowienieKlientController/Details/5
        public ActionResult Details(int id)
        {
            return View();
        }

        // GET: ZamowienieKlientController/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: ZamowienieKlientController/Create
        [HttpPost]
        ...
        // GET: ZamowienieKlientController/Edit/5
        public ActionResult Edit(int id)
        {
            return View();
        }

        // POST: ZamowienieKlientController/Edit/5
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: ZamowienieKlientController/Delete/5
        public ActionResult Delete(int id)
        {
            return View();
        }

        // POST: ZamowienieKlientController/Delete/5
        [HttpPost]
        [ValidateAntiForgeryToken]
